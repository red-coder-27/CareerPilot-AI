    ...
    return (
      <div className="max-w-md mx-auto my-20 p-8 bg-zinc-950/40 border border-zinc-800/60 backdrop-blur-md rounded-2xl text-center space-y-6">
        ...
        <div className="space-y-2">
          <h2 className="text-xl font-bold text-white">No Interview Practice Material</h2>
          <p className="text-xs text-zinc-400 leading-relaxed">
            Please upload and analyze a resume first. We will automatically generate tailored interview questions based on your specific gaps and background!
          </p>
        </div>
        <Link
          href="/analyze"
